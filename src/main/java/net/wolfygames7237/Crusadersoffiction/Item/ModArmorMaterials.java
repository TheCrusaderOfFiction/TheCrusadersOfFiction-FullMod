...
public enum ModArmorMaterials implements ArmorMaterial {
    WYSTERIUM("wysterium",26,new int[]{5,7,7,4}, 1,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 12,10, () -> Ingredient.of(ModItem.WYSTERIUM.get()));
    ...
    private static final int[] BASE_DURABILITY = { 11, 17, 16, 13 };
    ...
    public String getName() {
        return CrusadersOfFiction.MOD_ID + ":" + this.name;
    }
