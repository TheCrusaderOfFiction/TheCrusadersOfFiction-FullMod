...
public class EnchantedSwordProjectile2Model<T extends Entity> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("crusadersoffiction", "enchanted_sword_projectile2_layer"), "main");
    private final ModelPart bb_main;

    public EnchantedSwordProjectile2Model(ModelPart root) {
