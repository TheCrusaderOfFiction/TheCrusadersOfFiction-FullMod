...
public class EnchantedSwordProjectileEntity2 extends Projectile {
    private static final EntityDataAccessor<Boolean> HIT =
            SynchedEntityData.defineId(EnchantedSwordProjectileEntity2.class, EntityDataSerializers.BOOLEAN);
    private int counter = 0;


    public EnchantedSwordProjectileEntity2(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public EnchantedSwordProjectileEntity2(Level level, Player player) {
        super(ModEntities.ENCHANTED_SWORD_PROJECTILE2.get(), level);
        setOwner(player);
